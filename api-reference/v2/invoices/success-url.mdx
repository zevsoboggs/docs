...
### Оплата картой (Overpay / TBank)

<Steps>
  <Step title="Открытие страницы">
    Клиент открывает страницу оплаты Love&Pay
  </Step>
  <Step title="Редирект на шлюз">
    Перенаправляется на форму оплаты провайдера
  </Step>
  <Step title="Ввод данных">
    Вводит данные карты, проходит 3DS
  </Step>
  <Step title="Возврат">
    Провайдер возвращает клиента на `https://loveandpay.io/pay/INV-xxx`
  </Step>
  <Step title="Определение оплаты">
